...
class SCBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.ca = SELayer(planes*self.expansion)
        self.sa = cconv3x3(planes*self.expansion,planes*self.expansion)
...
net = ResNet(SCBottleneck, [3, 4, 6, 3])
...
for epoch in range(epochs):
    ...
    # 降低学习速度
    if (epoch + 1) % 30 == 0 :  # 每过20个Epoch，学习率就会下降
        curr_lr /= 3
